...
@EnableTransactionManagement //애노테이션 기반 트랜잭션 기능을 이용하기 위해 해당 애노테이션을 붙여야함.
public class DataSourceConfig {
    ...
    @Bean
    @ConditionalOnSingleCandidate(DataSource.class) // 데이터 소스의 타입이 싱글톤 빈이라면 이걸 가져와서 사용한다는 뜻.
    @ConditionalOnMissingBean
